...
namespace Opcodes {
	std::vector<Instruction> getInstructionVector() {
		...
		instructions.push_back(Instruction("LD (C), A", 0, 8, &Cpu::ld_cp_a));		//0xE2
	...
	std::vector<Instruction> getExtendedInstructionVector() {
		...
		ins.push_back(Instruction("RLC B", 0, 8, &Cpu::rlc_b));
		ins.push_back(Instruction("RLC C", 0, 8, &Cpu::rlc_c));
		ins.push_back(Instruction("RLC D", 0, 8, &Cpu::rlc_d));
		...
		ins.push_back(Instruction("RRC D", 0, 8, &Cpu::rrc_d));
		ins.push_back(Instruction("RRC E", 0, 8, &Cpu::rrc_e));
		ins.push_back(Instruction("RRC H", 0, 8, &Cpu::rrc_h));
		...
		ins.push_back(Instruction("RL H", 0, 8, &Cpu::rl_h));
		ins.push_back(Instruction("RL L", 0, 8, &Cpu::rl_l));
		ins.push_back(Instruction("RL (HL)", 0, 16, &Cpu::rl_hlp));
		ins.push_back(Instruction("RL A", 0, 8, &Cpu::rl_a));
		ins.push_back(Instruction("RR B", 0, 8, &Cpu::rr_b));
		ins.push_back(Instruction("RR C", 0, 8, &Cpu::rr_c));
		ins.push_back(Instruction("RR D", 0, 8, &Cpu::rr_d));
		ins.push_back(Instruction("RR E", 0, 8, &Cpu::rr_e));
		ins.push_back(Instruction("RR H", 0, 8, &Cpu::rr_h));
		...
		ins.push_back(Instruction("SLA H", 0, 8, &Cpu::sla_h));
		ins.push_back(Instruction("SLA L", 0, 8, &Cpu::sla_l));
		ins.push_back(Instruction("SLA (HL)", 0, 16, &Cpu::sla_hlp));
		ins.push_back(Instruction("SLA A", 0, 8, &Cpu::sla_a));
		ins.push_back(Instruction("SRA B", 0, 8, &Cpu::sra_b));
		ins.push_back(Instruction("SRA C", 0, 8, &Cpu::sra_c));
		ins.push_back(Instruction("SRA D", 0, 8, &Cpu::sra_d));
		ins.push_back(Instruction("SRA E", 0, 8, &Cpu::sra_e));
		...
		ins.push_back(Instruction("SWAP H", 0, 8, &Cpu::swap_h));
		ins.push_back(Instruction("SWAP L", 0, 8, &Cpu::swap_l));
		ins.push_back(Instruction("SWAP (HL)", 0, 16, &Cpu::swap_hlp));
		ins.push_back(Instruction("SWAP A", 0, 8, &Cpu::swap_a));
		ins.push_back(Instruction("SRL B", 0, 8, &Cpu::srl_b));
		ins.push_back(Instruction("SRL C", 0, 8, &Cpu::srl_c));
		ins.push_back(Instruction("SRL D", 0, 8, &Cpu::srl_d));
		ins.push_back(Instruction("SRL E", 0, 8, &Cpu::srl_e));
		ins.push_back(Instruction("SRL H", 0, 8, &Cpu::srl_h));
		...
		ins.push_back(Instruction("BIT 0, H", 0, 8, &Cpu::bit0_h));
		ins.push_back(Instruction("BIT 0, L", 0, 8, &Cpu::bit0_l));
		ins.push_back(Instruction("BIT 0, (HL)", 0, 16, &Cpu::bit0_hlp));
		ins.push_back(Instruction("BIT 0, A", 0, 8, &Cpu::bit0_a));
		ins.push_back(Instruction("BIT 1, B", 0, 8, &Cpu::bit1_b));
		ins.push_back(Instruction("BIT 1, C", 0, 8, &Cpu::bit1_c));
		ins.push_back(Instruction("BIT 1, D", 0, 8, &Cpu::bit1_d));
		ins.push_back(Instruction("BIT 1, E", 0, 8, &Cpu::bit1_e));
		ins.push_back(Instruction("BIT 1, H", 0, 8, &Cpu::bit1_h));
		...
		ins.push_back(Instruction("BIT 2, H", 0, 8, &Cpu::bit2_h));
		ins.push_back(Instruction("BIT 2, L", 0, 8, &Cpu::bit2_l));
		ins.push_back(Instruction("BIT 2, (HL)", 0, 16, &Cpu::bit2_hlp));
		ins.push_back(Instruction("BIT 2, A", 0, 8, &Cpu::bit2_a));
		ins.push_back(Instruction("BIT 3, B", 0, 8, &Cpu::bit3_b));
		ins.push_back(Instruction("BIT 3, C", 0, 8, &Cpu::bit3_c));
		ins.push_back(Instruction("BIT 3, D", 0, 8, &Cpu::bit3_d));
		ins.push_back(Instruction("BIT 3, E", 0, 8, &Cpu::bit3_e));
		ins.push_back(Instruction("BIT 3, H", 0, 8, &Cpu::bit3_h));
		...
		ins.push_back(Instruction("BIT 4, H", 0, 8, &Cpu::bit4_h));
		ins.push_back(Instruction("BIT 4, L", 0, 8, &Cpu::bit4_l));
		ins.push_back(Instruction("BIT 4, (HL)", 0, 16, &Cpu::bit4_hlp));
		ins.push_back(Instruction("BIT 4, A", 0, 8, &Cpu::bit4_a));
		ins.push_back(Instruction("BIT 5, B", 0, 8, &Cpu::bit5_b));
		ins.push_back(Instruction("BIT 5, C", 0, 8, &Cpu::bit5_c));
		ins.push_back(Instruction("BIT 5, D", 0, 8, &Cpu::bit5_d));
		ins.push_back(Instruction("BIT 5, E", 0, 8, &Cpu::bit5_e));
		ins.push_back(Instruction("BIT 5, H", 0, 8, &Cpu::bit5_h));
		...
		ins.push_back(Instruction("BIT 6, H", 0, 8, &Cpu::bit6_h));
		ins.push_back(Instruction("BIT 6, L", 0, 8, &Cpu::bit6_l));
		ins.push_back(Instruction("BIT 6, (HL)", 0, 16, &Cpu::bit6_hlp));
		ins.push_back(Instruction("BIT 6, A", 0, 8, &Cpu::bit6_a));
		ins.push_back(Instruction("BIT 7, B", 0, 8, &Cpu::bit7_b));
		ins.push_back(Instruction("BIT 7, C", 0, 8, &Cpu::bit7_c));
		ins.push_back(Instruction("BIT 7, D", 0, 8, &Cpu::bit7_d));
		ins.push_back(Instruction("BIT 7, E", 0, 8, &Cpu::bit7_e));
		ins.push_back(Instruction("BIT 7, H", 0, 8, &Cpu::bit7_h));
		...
		ins.push_back(Instruction("RES 0, H", 0, 8, &Cpu::res0_h));
		ins.push_back(Instruction("RES 0, L", 0, 8, &Cpu::res0_l));
		ins.push_back(Instruction("RES 0, (HL)", 0, 16, &Cpu::res0_hlp));
		ins.push_back(Instruction("RES 0, A", 0, 8, &Cpu::res0_a));
		ins.push_back(Instruction("RES 1, B", 0, 8, &Cpu::res1_b));
		ins.push_back(Instruction("RES 1, C", 0, 8, &Cpu::res1_c));
		ins.push_back(Instruction("RES 1, D", 0, 8, &Cpu::res1_d));
		ins.push_back(Instruction("RES 1, E", 0, 8, &Cpu::res1_e));
		ins.push_back(Instruction("RES 1, H", 0, 8, &Cpu::res1_h));
		...
		ins.push_back(Instruction("RES 2, H", 0, 8, &Cpu::res2_h));
		ins.push_back(Instruction("RES 2, L", 0, 8, &Cpu::res2_l));
		ins.push_back(Instruction("RES 2, (HL)", 0, 16, &Cpu::res2_hlp));
		ins.push_back(Instruction("RES 2, A", 0, 8, &Cpu::res2_a));
		ins.push_back(Instruction("RES 3, B", 0, 8, &Cpu::res3_b));
		ins.push_back(Instruction("RES 3, C", 0, 8, &Cpu::res3_c));
		ins.push_back(Instruction("RES 3, D", 0, 8, &Cpu::res3_d));
		ins.push_back(Instruction("RES 3, E", 0, 8, &Cpu::res3_e));
		ins.push_back(Instruction("RES 3, H", 0, 8, &Cpu::res3_h));
		...
		ins.push_back(Instruction("RES 4, H", 0, 8, &Cpu::res4_h));
		ins.push_back(Instruction("RES 4, L", 0, 8, &Cpu::res4_l));
		ins.push_back(Instruction("RES 4, (HL)", 0, 16, &Cpu::res4_hlp));
		ins.push_back(Instruction("RES 4, A", 0, 8, &Cpu::res4_a));
		ins.push_back(Instruction("RES 5, B", 0, 8, &Cpu::res5_b));
		ins.push_back(Instruction("RES 5, C", 0, 8, &Cpu::res5_c));
		ins.push_back(Instruction("RES 5, D", 0, 8, &Cpu::res5_d));
		ins.push_back(Instruction("RES 5, E", 0, 8, &Cpu::res5_e));
		ins.push_back(Instruction("RES 5, H", 0, 8, &Cpu::res5_h));
		...
		ins.push_back(Instruction("RES 6, H", 0, 8, &Cpu::res6_h));
		ins.push_back(Instruction("RES 6, L", 0, 8, &Cpu::res6_l));
		ins.push_back(Instruction("RES 6, (HL)", 0, 16, &Cpu::res6_hlp));
		ins.push_back(Instruction("RES 6, A", 0, 8, &Cpu::res6_a));
		ins.push_back(Instruction("RES 7, B", 0, 8, &Cpu::res7_b));
		ins.push_back(Instruction("RES 7, C", 0, 8, &Cpu::res7_c));
		ins.push_back(Instruction("RES 7, D", 0, 8, &Cpu::res7_d));
		ins.push_back(Instruction("RES 7, E", 0, 8, &Cpu::res7_e));
		ins.push_back(Instruction("RES 7, H", 0, 8, &Cpu::res7_h));
		...
		ins.push_back(Instruction("SET 0, H", 0, 8, &Cpu::set0_h));
		ins.push_back(Instruction("SET 0, L", 0, 8, &Cpu::set0_l));
		ins.push_back(Instruction("SET 0, (HL)", 0, 16, &Cpu::set0_hlp));
		ins.push_back(Instruction("SET 0, A", 0, 8, &Cpu::set0_a));
		ins.push_back(Instruction("SET 1, B", 0, 8, &Cpu::set1_b));
		ins.push_back(Instruction("SET 1, C", 0, 8, &Cpu::set1_c));
		ins.push_back(Instruction("SET 1, D", 0, 8, &Cpu::set1_d));
		ins.push_back(Instruction("SET 1, E", 0, 8, &Cpu::set1_e));
		ins.push_back(Instruction("SET 1, H", 0, 8, &Cpu::set1_h));
		...
		ins.push_back(Instruction("SET 2, H", 0, 8, &Cpu::set2_h));
		ins.push_back(Instruction("SET 2, L", 0, 8, &Cpu::set2_l));
		ins.push_back(Instruction("SET 2, (HL)", 0, 16, &Cpu::set2_hlp));
		ins.push_back(Instruction("SET 2, A", 0, 8, &Cpu::set2_a));
		ins.push_back(Instruction("SET 3, B", 0, 8, &Cpu::set3_b));
		ins.push_back(Instruction("SET 3, C", 0, 8, &Cpu::set3_c));
		ins.push_back(Instruction("SET 3, D", 0, 8, &Cpu::set3_d));
		ins.push_back(Instruction("SET 3, E", 0, 8, &Cpu::set3_e));
		ins.push_back(Instruction("SET 3, H", 0, 8, &Cpu::set3_h));
		...
		ins.push_back(Instruction("SET 4, H", 0, 8, &Cpu::set4_h));
		ins.push_back(Instruction("SET 4, L", 0, 8, &Cpu::set4_l));
		ins.push_back(Instruction("SET 4, (HL)", 0, 16, &Cpu::set4_hlp));
		ins.push_back(Instruction("SET 4, A", 0, 8, &Cpu::set4_a));
		ins.push_back(Instruction("SET 5, B", 0, 8, &Cpu::set5_b));
		ins.push_back(Instruction("SET 5, C", 0, 8, &Cpu::set5_c));
		ins.push_back(Instruction("SET 5, D", 0, 8, &Cpu::set5_d));
		ins.push_back(Instruction("SET 5, E", 0, 8, &Cpu::set5_e));
		...
		ins.push_back(Instruction("SET 6, H", 0, 8, &Cpu::set6_h));
		ins.push_back(Instruction("SET 6, L", 0, 8, &Cpu::set6_l));
		ins.push_back(Instruction("SET 6, (HL)", 0, 16, &Cpu::set6_hlp));
		ins.push_back(Instruction("SET 6, A", 0, 8, &Cpu::set6_a));
		ins.push_back(Instruction("SET 7, B", 0, 8, &Cpu::set7_b));
		ins.push_back(Instruction("SET 7, C", 0, 8, &Cpu::set7_c));
		ins.push_back(Instruction("SET 7, D", 0, 8, &Cpu::set7_d));
		ins.push_back(Instruction("SET 7, E", 0, 8, &Cpu::set7_e));
		ins.push_back(Instruction("SET 7, H", 0, 8, &Cpu::set7_h));
		ins.push_back(Instruction("SET 7, L", 0, 8, &Cpu::set7_l));
		ins.push_back(Instruction("SET 7, (HL)", 0, 16, &Cpu::set7_hlp));
		ins.push_back(Instruction("SET 7, A", 0, 8, &Cpu::set7_a));
